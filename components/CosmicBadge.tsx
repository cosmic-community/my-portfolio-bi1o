...
export default function CosmicBadge({ bucketSlug }: { bucketSlug: string }) {
  ...
  return (
    <a
      ...
      className="flex items-center gap-2 text-gray-800 text-sm font-medium no-underline z-50"
      style={{
        position: 'fixed',
        bottom: '20px',
        right: '20px',
    ...
    >
      <button
        ...
        className="absolute -top-2 -right-2 w-6 h-6 bg-gray-100 hover:bg-gray-200 text-gray-800 rounded-full flex items-center justify-center text-sm font-bold z-10"
